	...
	return (
		(taskList.length > 0
			&& <DataView
					...
					paginatorTemplate={window.innerWidth >= 576 ? "FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink RowsPerPageDropdown" : "PrevPageLink PageLinks NextPageLink RowsPerPageDropdown"}
